...
public class TightAuthentication extends AuthHandler {
	...
	@Override
	public boolean authenticate(Transport.Reader reader, Transport.Writer writer,
	 ...
	 *
	 */
	private void initTunnelling(Transport.Reader reader, Transport.Writer writer)
	 ...
	 */
	private void initAuthorization(Transport.Reader reader, Transport.Writer writer,
			CapabilityContainer authCaps, IPasswordRetriever passwordRetriever)
