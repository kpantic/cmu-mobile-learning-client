...
implements MouseWheelListener {
	...
	public MouseEventListener(IRepaintController repaintController,
	...
	public void processMouseEvent(MouseEvent mouseEvent,
		...
		short x = (short)mouseEvent.getX();
		short y = (short)mouseEvent.getY();
		if (moved) {
		...
		if (mouseWheelEvent != null) {
			...
			for (int i=1; i<notches; ++i) {
				queue.put(new PointerEventMessage((byte) (buttonMask | wheelMask), x, y));
				queue.put(new PointerEventMessage(buttonMask, x, y));
			}
			queue.put(new PointerEventMessage((byte) (buttonMask | wheelMask), x, y));
		}
		queue.put(new PointerEventMessage(buttonMask, x, y));
