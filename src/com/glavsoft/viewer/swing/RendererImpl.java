...
public class RendererImpl extends Renderer implements ImageObserver {
	private Image offscreanImage;
	public RendererImpl(Transport.Reader reader, int width, int height, PixelFormat pixelFormat) {
		this.reader = reader;
		this.width = width;
		this.height = height;
		this.pixelFormat = pixelFormat;
		this.bytesPerPixel = pixelFormat.bitsPerPixel / 8;
		this.bytesPerPixelSignificant = pixelFormat.depth / 8;
